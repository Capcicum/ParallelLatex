...
The Host Interface does so, by reading commands such as copying memory and launching \textit{Kernels} (further described in \cref{sec-pm-kernels}), and dispatches these commands to the appropriate hardware units.
