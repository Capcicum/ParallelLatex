...
%Global Scheduler
The Global Scheduler, also known as "GigaThread Engine" by Nvidia \cite{Nvidia2009}, is responsible of distributing parallel threads to SMs, where they are executed.
