The communication between the CPU and GPU is handled through the high-speed serial computer expansion bus standard Pheripheral Component Interconnect Express (PCI Express).
